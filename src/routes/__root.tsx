...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Beecause by The Hive — Creating Change Together" },
      {
        name: "description",
        content:
          "Beecause by The Hive brings creativity, community and action together to create meaningful change.",
      },
      { property: "og:site_name", content: "Beecause by The Hive" },
    ...
    links: [
      ...
      {
        rel: "stylesheet",
        href: "https://googleapis.com/css2?family=Fraunces:opsz,wght@9..144,300;9..144,400;9..144,500&family=DM+Sans:wght@400;500&display=swap",
      },
